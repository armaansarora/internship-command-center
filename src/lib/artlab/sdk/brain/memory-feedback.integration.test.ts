...
beforeEach(() => {
  ...
  writeFileSync(
    ...
    [
      JSON.stringify({ at: "2026-05-24T12:00:00.000Z", characterId: "rafe-calder", lane: 1, reason: "wrong jacket", codes: ["WARDROBE"], promptHash: "h0", source: "character" }),
      JSON.stringify({ at: "2026-05-24T13:00:00.000Z", characterId: "war-room", lane: 1, reason: "wrong light", codes: ["LIGHT"], promptHash: "h0b", source: "floor" }),
    ].join("\n") + "\n",
  );
});
