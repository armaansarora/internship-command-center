...
// System prompts per decision kind. The Tower context bundle is injected by the
// caller as `req.input.towerContext` — the system prompts here describe how to
// USE that context. Keep them stable so Anthropic's ephemeral prompt cache
