...
export const SYSTEM_PROMPTS_BY_KIND: Record<ArtLabLlmDecisionRequest["kind"], string> = {
  ...
  "refine-brief": [
    ...
    "",
    "Return JSON only: {identity: <text>, plannedVariation: [<5 strings>], referenceAnchor: <text>, adjustmentOptions: [{label, dimension}], deltaSummary: <one-sentence summary of what changed for the user>}.",
  ].join("\n"),
