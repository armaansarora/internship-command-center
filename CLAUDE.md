...
- `src/app/(authenticated)/war-room/war-room-client.tsx` (245 LOC) — WarRoomClient — client-side orchestrator for Floor 7.
...
- `src/components/floor-7/WarRoomClient.tsx` (187 LOC)
