...
- `src/app/lobby/lobby-client.tsx` (933 LOC) — Lobby client component — The Tower entrance.
...
- `src/components/world/LobbyBackground.tsx` (239 LOC) — LobbyBackground — Apple TV Saver-style Ken Burns backgrounds.
...
- `src/components/agents/dialogue/AgentDialoguePanel.tsx` (202 LOC)
...
- `src/components/floor-1/CSuiteClient.tsx` (175 LOC)
...
- `src/components/floor-1/ceo-character/CEODialoguePanel.tsx` (155 LOC)
