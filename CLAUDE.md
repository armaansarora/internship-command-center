...
- `src/app/(authenticated)/penthouse/penthouse-client.tsx` (1209 LOC)
- `src/components/world/Elevator.tsx` (1015 LOC) — Elevator — persistent left-side navigation with GSAP door transitions.
- `src/app/lobby/lobby-client.tsx` (925 LOC) — Lobby client component — The Tower entrance.
- `src/components/world/ProceduralSkyline.tsx` (705 LOC) — Canvas-based procedural renderer
...
- `src/components/world/FloorShell.tsx` (198 LOC) — FloorShell — wraps each floor's content with the immersive procedural skyline.
