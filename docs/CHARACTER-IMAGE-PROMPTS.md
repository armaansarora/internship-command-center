...
- Use ChatGPT image generation under Armaan's subscription unless he explicitly approves another path.
...
- Ask for exactly 12 concept options when making a concept board.
...
- The promoted Otis pilot records prototype-source upscaling warnings; future runs should use native high-resolution source art before final approval.
