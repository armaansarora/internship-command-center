...
After Armaan picks the design, create the production pack from that approved identity: turnaround, outfit variants, expression sheet, 7 poses x 3 outfits, 4K masters, alpha extraction through a flat #00ff00 matte where needed, derivatives, QA, strict Asset Doctor, final upload-ready board, and app preview. Generated files stay in .artlab until promotion.
