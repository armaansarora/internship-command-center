...
| `BOOTSTRAP-PROMPT.md` | Auto-generated session entry point — source tree, build health, acceptance criteria (root) | ~580 |
| `CLAUDE.md` | Codebase summary, conventions, agent behavior rules, doc architecture (root) | ~420 |
