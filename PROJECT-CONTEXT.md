...
| `BOOTSTRAP-PROMPT.md` | Auto-generated session entry point — source tree, build health, acceptance criteria (root) | ~660 |
...
| `docs/AUDIT-DEPLOY-CHECKLIST.md` | **Read this first.** This is the dummy-proof, click-by-click, paste-by-paste gui | ~360 |
