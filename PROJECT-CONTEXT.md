...
| `BOOTSTRAP-PROMPT.md` | Auto-generated session entry point — source tree, build health, acceptance criteria (root) | ~590 |
| `CLAUDE.md` | Codebase summary, conventions, agent behavior rules, doc architecture (root) | ~320 |
...
| `docs/NEXT-ROADMAP.md` | **Audience.** Any Claude session working on The Tower. And Armaan, once per phas | ~960 |
