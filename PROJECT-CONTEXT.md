...
| `BOOTSTRAP-PROMPT.md` | Auto-generated session entry point — source tree, build health, acceptance criteria (root) | ~1110 |
...
| `docs/KEY-COMPONENTS.md` | - `src/app/(authenticated)/settings/settings-client.tsx` (1341 LOC) — R0.7 — `us | ~210 |
