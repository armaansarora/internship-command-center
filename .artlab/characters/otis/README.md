...
Current warning: the live pilot was built from prototype-sized transparent sources that were upscaled into 4K masters. The pipeline records that honestly in `run.json`; Otis v2 must replace those sources with native high-resolution generation before Mara Voss work begins.
