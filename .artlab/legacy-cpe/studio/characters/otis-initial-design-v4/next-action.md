# Creative Production Engine Packet

## Next Legal Action

Generate concept options for Otis.

- Asset type: character
- Run id: otis-initial-design-v4
- Status: brief-ready
- Promotion phrase: approved for app
- Next action id: generate-concept-options
- Routed from request: Routed to character because the request matched character identity, cast, outfit, pose, or sprite language.
