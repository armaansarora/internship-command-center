...
`.artlab/studio/characters/otis-initial-design-v4/parallel/lanes/wave-01-agent-04`

Expected files:
- `.artlab/studio/characters/otis-initial-design-v4/parallel/lanes/wave-01-agent-04/result.md`
- `.artlab/studio/characters/otis-initial-design-v4/parallel/lanes/wave-01-agent-04/result.json`
- `.artlab/studio/characters/otis-initial-design-v4/parallel/lanes/wave-01-agent-04/preflight.json` if you create or inspect images
- generated or staged exploratory outputs under `.artlab/studio/characters/otis-initial-design-v4/parallel/lanes/wave-01-agent-04/outputs`

Create at least one concrete artifact under `.artlab/studio/characters/otis-initial-design-v4/parallel/lanes/wave-01-agent-04/outputs`, such as a prompt packet, source image, contact sheet, QA note, component sketch, or animation plan. A lane with only prose and no artifact is incomplete.
