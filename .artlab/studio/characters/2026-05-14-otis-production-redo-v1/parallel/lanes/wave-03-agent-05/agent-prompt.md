# Creative Production Engine Lane: wave-03-agent-05
...
Creative strategy: Wild Card - Make the boldest useful variation that still obeys the asset contract and quality bar.

## Write Scope

You may write only inside:

`.artlab/studio/characters/2026-05-14-otis-production-redo-v1/parallel/lanes/wave-03-agent-05`

Expected files:
- `.artlab/studio/characters/2026-05-14-otis-production-redo-v1/parallel/lanes/wave-03-agent-05/result.md`
- `.artlab/studio/characters/2026-05-14-otis-production-redo-v1/parallel/lanes/wave-03-agent-05/result.json`
- `.artlab/studio/characters/2026-05-14-otis-production-redo-v1/parallel/lanes/wave-03-agent-05/preflight.json` if you create or inspect images
- generated or staged exploratory outputs under `.artlab/studio/characters/2026-05-14-otis-production-redo-v1/parallel/lanes/wave-03-agent-05/outputs`

Create at least one concrete artifact under `.artlab/studio/characters/2026-05-14-otis-production-redo-v1/parallel/lanes/wave-03-agent-05/outputs`, such as a prompt packet, source image, contact sheet, QA note, component sketch, or animation plan. A lane with only prose and no artifact is incomplete.
