# Creative Production Engine Lane: wave-01-agent-02
...
Creative strategy: Silhouette Breaker - Push shape language, posture, and read-at-a-distance variety harder than the baseline.

## Write Scope

You may write only inside:

`.artlab/studio/characters/2026-05-14-otis-production-redo-v1/parallel/lanes/wave-01-agent-02`

Expected files:
- `.artlab/studio/characters/2026-05-14-otis-production-redo-v1/parallel/lanes/wave-01-agent-02/result.md`
- `.artlab/studio/characters/2026-05-14-otis-production-redo-v1/parallel/lanes/wave-01-agent-02/result.json`
- `.artlab/studio/characters/2026-05-14-otis-production-redo-v1/parallel/lanes/wave-01-agent-02/preflight.json` if you create or inspect images
- generated or staged exploratory outputs under `.artlab/studio/characters/2026-05-14-otis-production-redo-v1/parallel/lanes/wave-01-agent-02/outputs`

Create at least one concrete artifact under `.artlab/studio/characters/2026-05-14-otis-production-redo-v1/parallel/lanes/wave-01-agent-02/outputs`, such as a prompt packet, source image, contact sheet, QA note, component sketch, or animation plan. A lane with only prose and no artifact is incomplete.
