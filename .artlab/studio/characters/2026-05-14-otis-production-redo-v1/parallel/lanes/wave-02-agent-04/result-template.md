...
- TBD
- Create at least one concrete artifact under `.artlab/studio/characters/2026-05-14-otis-production-redo-v1/parallel/lanes/wave-02-agent-04/outputs`. A lane with only prose and no artifact is incomplete.

## Structured Result

Write this JSON to `.artlab/studio/characters/2026-05-14-otis-production-redo-v1/parallel/lanes/wave-02-agent-04/result.json`:

```json
{
  "laneId": "wave-02-agent-04",
