...
`.artlab/studio/characters/2026-05-14-otis-production-redo-v1/parallel/lanes/wave-01-agent-01`
...
- `.artlab/studio/characters/2026-05-14-otis-production-redo-v1/parallel/lanes/wave-01-agent-01/preflight.json` if you create or inspect images
- generated or staged exploratory outputs under `.artlab/studio/characters/2026-05-14-otis-production-redo-v1/parallel/lanes/wave-01-agent-01/outputs`

Create at least one concrete artifact under `.artlab/studio/characters/2026-05-14-otis-production-redo-v1/parallel/lanes/wave-01-agent-01/outputs`, such as a prompt packet, source image, contact sheet, QA note, component sketch, or animation plan. A lane with only prose and no artifact is incomplete.
