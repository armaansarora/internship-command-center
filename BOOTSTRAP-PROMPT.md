...
```
2f6cfc4 [R0/0.7] feat: account deletion — soft-delete + 30-day purge sweeper
```
...
| Service | Detail |
|---|---|
| Repo | `armaansarora/internship-command-center` on `main` (commit `2f6cfc4`) |
