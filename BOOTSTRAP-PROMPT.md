...
> **Auto-generated** by `scripts/generate-bootstrap.ts` on Monday, April 20, 2026 at 6:12 PM EDT
...
- **Branch:** `main` (commit `77f91a6`)
- **Production:** `internship-command-center-lake.vercel.app`
- **Total LOC:** 52,987 across 264 source files
...
```
77f91a6 fix(elevator + confetti): kill interstitial flicker + restore milestone animations
```
...
| Service | Detail |
|---|---|
| Repo | `armaansarora/internship-command-center` on `main` (commit `77f91a6`) |
...
## Source Tree (264 files, 52,987 LOC)

| Directory | LOC |
|---|---|
| `src/lib/db/queries` | 4154 |
| `src/components/world` | 2979 |
| `src/styles` | 2493 |
...
| File | Lines | ~Tokens |
|---|---|---|
| `BOOTSTRAP-PROMPT.md` | 583 | 5,910 |
| `PROJECT-CONTEXT.md` | 278 | 5,167 |
| `docs/MASTER-PLAN.md` | 367 | 7,172 |
| `CLAUDE.md` | 314 | 6,480 |
| **Total** | **1542** | **24,729** |

> ⚠️ Reading all recommended files consumes ~24,729 tokens. Prioritize: this file → CLAUDE.md (mandatory) → PROJECT-CONTEXT.md → MASTER-PLAN.md.
