...
> **Auto-generated** by `scripts/generate-bootstrap.ts` on Friday, April 24, 2026 at 8:50 AM EDT
...
```
4a92202 chore(handoff): session sess-a5908e — R0
```
...
| Service | Detail |
|---|---|
| Repo | `armaansarora/internship-command-center` on `main` (commit `4a92202`) |
...
| File | Lines | ~Tokens |
|---|---|---|
| `BOOTSTRAP-PROMPT.md` | 1103 | 12,334 |
| `PROJECT-CONTEXT.md` | 283 | 5,309 |
| `docs/MASTER-PLAN.md` | 367 | 7,172 |
| `CLAUDE.md` | 346 | 6,466 |
| **Total** | **2099** | **31,281** |

> ⚠️ Reading all recommended files consumes ~31,281 tokens. Prioritize: this file → CLAUDE.md (mandatory) → PROJECT-CONTEXT.md → MASTER-PLAN.md.
