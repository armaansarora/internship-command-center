...
> **Auto-generated** by `scripts/generate-bootstrap.ts` on Friday, April 24, 2026 at 4:16 PM EDT
...
```
d960cf6 [R12/12.2] feat(r12): auth + mock-supabase helpers, fixture loader, assertion primitives
```
...
| Service | Detail |
|---|---|
| Repo | `armaansarora/internship-command-center` on `main` (commit `d960cf6`) |
...
| File | Lines | ~Tokens |
|---|---|---|
| `BOOTSTRAP-PROMPT.md` | 1155 | 13,089 |
| `PROJECT-CONTEXT.md` | 277 | 5,128 |
| `docs/MASTER-PLAN.md` | 367 | 7,172 |
| `CLAUDE.md` | 340 | 6,341 |
| **Total** | **2139** | **31,730** |

> ⚠️ Reading all recommended files consumes ~31,730 tokens. Prioritize: this file → CLAUDE.md (mandatory) → PROJECT-CONTEXT.md → MASTER-PLAN.md.
