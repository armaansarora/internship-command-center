...
> **Auto-generated** by `scripts/generate-bootstrap.ts` on Sunday, April 26, 2026 at 7:08 PM EDT
...
- **Branch:** `main` (commit `02504ff`)
- **Production:** `internship-command-center-lake.vercel.app`
- **Total LOC:** 122,819 across 713 source files
- **Build:** Clean (zero TS errors)

### ⚠️ Stale Docs Detected
- **`docs/MASTER-PLAN.md`**: Last updated 2026-04-17 (10d ago)
- **`docs/VISION-SPEC.md`**: Last updated 2026-04-17 (10d ago)
- **`docs/TECH-BRIEF.md`**: Last updated 2026-04-17 (10d ago)
...
```
02504ff chore(launch-prep): add owner-account seed script
```
...
| Service | Detail |
|---|---|
| Repo | `armaansarora/internship-command-center` on `main` (commit `02504ff`) |
...
| `src/lib/networking` | 802 |
| `src/lib/penthouse` | 796 |
| `src/app/api/cron/draft-follow-ups` | 795 |
...
| `src/lib/stripe` | 585 |
| `src/app/api/cron/packet-regenerate` | 584 |
| `src/app/api/cron/unprompted-ceo` | 576 |
...
| `src/app/api/cron/purge-sweeper` | 442 |
...
| `src/app/api/networking/revoke/__tests__` | 222 |
| `src/app/api/cron/__integration__` | 221 |
| `src/app/api/cron/sync` | 216 |
| `src/app/api/networking/match-candidates/__tests__` | 214 |
| `src/app/api/cron/outreach-sender` | 212 |
...
| `src/app/api/cron/cfo-threshold` | 196 |
...
| `src/app/api/cron/warm-intro-scan` | 163 |
| `src/app/api/cron/export-worker` | 160 |
...
| `src/app/api/cron/cio-reresearch` | 144 |
...
| `src/app/api/writing-room/compose-stream` | 121 |
| `src/app/api/concierge/chat` | 119 |
| `src/app/api/cron/warmth-decay` | 118 |
| `src/lib/cron` | 116 |
| `src/app/api/briefing/binder/[id]` | 114 |
| `src/app/api/documents/[id]/pdf` | 111 |
| `src/app/api/writing-room/compose-stream/__tests__` | 111 |
| `src/components/penthouse/scenes/evening` | 110 |
| `src/lib/parlor` | 110 |
| `src/app/api/gmail/callback` | 108 |
| `src/app/(authenticated)/observatory` | 106 |
| `src/app/api/networking/revoke` | 106 |
| `src/app/api/cron/match-index` | 105 |
| `src/components/penthouse/scenes/afternoon` | 105 |
| `src/app/api/networking/match-candidates` | 102 |
...
| `src/app/api/cron/job-discovery` | 84 |
...
src/app/api/comp-bands/lookup/route.test.ts
...
src/app/api/cron/match-index/__tests__/route.test.ts
...
src/app/api/networking/revoke/__tests__/route.test.ts
src/app/api/networking/revoke/route.ts
src/app/api/notifications/[id]/read/route.ts
src/app/api/notifications/route.ts
src/app/api/offers/[id]/convene/route.test.ts
src/app/api/offers/[id]/convene/route.ts
src/app/api/offers/[id]/negotiation-draft/route.test.ts
...
src/app/api/offers/__tests__/route.integration.test.ts
src/app/api/offers/ingest-email/route.ts
...
src/components/parlor/ThreeChairsConvening.test.tsx
...
src/lib/comp-bands/__tests__/lookup.test.ts
...
src/lib/networking/__tests__/rate-limit.test.ts
...
src/lib/preferences/__tests__/r10-prefs.test.ts
src/lib/preferences/__tests__/read.test.ts
...
src/lib/situation/deadline-cron.test.ts
...
| File | Lines | ~Tokens |
|---|---|---|
| `BOOTSTRAP-PROMPT.md` | 1204 | 13,499 |
| `PROJECT-CONTEXT.md` | 278 | 5,161 |
| `docs/MASTER-PLAN.md` | 367 | 7,172 |
| `CLAUDE.md` | 340 | 6,341 |
| **Total** | **2189** | **32,173** |

> ⚠️ Reading all recommended files consumes ~32,173 tokens. Prioritize: this file → CLAUDE.md (mandatory) → PROJECT-CONTEXT.md → MASTER-PLAN.md.
