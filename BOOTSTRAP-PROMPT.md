...
> **Auto-generated** by `scripts/generate-bootstrap.ts` on Friday, April 24, 2026 at 4:25 PM EDT
...
```
dd955d3 [R12/12.9] feat(r12): R9 Orrery frame-timing carryover proof
```
...
| Service | Detail |
|---|---|
| Repo | `armaansarora/internship-command-center` on `main` (commit `dd955d3`) |
...
| File | Lines | ~Tokens |
|---|---|---|
| `BOOTSTRAP-PROMPT.md` | 1155 | 13,092 |
| `PROJECT-CONTEXT.md` | 277 | 5,128 |
| `docs/MASTER-PLAN.md` | 367 | 7,172 |
| `CLAUDE.md` | 340 | 6,341 |
| **Total** | **2139** | **31,733** |

> ⚠️ Reading all recommended files consumes ~31,733 tokens. Prioritize: this file → CLAUDE.md (mandatory) → PROJECT-CONTEXT.md → MASTER-PLAN.md.
