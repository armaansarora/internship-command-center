...
> **Auto-generated** by `scripts/generate-bootstrap.ts` on Friday, April 24, 2026 at 4:06 PM EDT
...
```
2724494 [R12/12.1] chore(r12): Playwright harness config + directory scaffold
```
...
| Service | Detail |
|---|---|
| Repo | `armaansarora/internship-command-center` on `main` (commit `2724494`) |
...
| File | Lines | ~Tokens |
|---|---|---|
| `BOOTSTRAP-PROMPT.md` | 1149 | 13,055 |
| `PROJECT-CONTEXT.md` | 277 | 5,128 |
| `docs/MASTER-PLAN.md` | 367 | 7,172 |
| `CLAUDE.md` | 340 | 6,341 |
| **Total** | **2133** | **31,696** |

> ⚠️ Reading all recommended files consumes ~31,696 tokens. Prioritize: this file → CLAUDE.md (mandatory) → PROJECT-CONTEXT.md → MASTER-PLAN.md.
