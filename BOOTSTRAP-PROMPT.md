...
> **Auto-generated** by `scripts/generate-bootstrap.ts` on Tuesday, April 21, 2026 at 11:20 PM EDT
...
```
11c68ad feat(tower): repo root resolver + config loader
```
...
| Service | Detail |
|---|---|
| Repo | `armaansarora/internship-command-center` on `main` (commit `11c68ad`) |
...
| File | Lines | ~Tokens |
|---|---|---|
| `BOOTSTRAP-PROMPT.md` | 589 | 5,947 |
| `PROJECT-CONTEXT.md` | 279 | 5,201 |
| `docs/MASTER-PLAN.md` | 367 | 7,172 |
| `CLAUDE.md` | 315 | 6,531 |
| **Total** | **1550** | **24,851** |

> ⚠️ Reading all recommended files consumes ~24,851 tokens. Prioritize: this file → CLAUDE.md (mandatory) → PROJECT-CONTEXT.md → MASTER-PLAN.md.
