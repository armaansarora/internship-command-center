...
> **Auto-generated** by `scripts/generate-bootstrap.ts` on Wednesday, April 22, 2026 at 10:23 PM EDT
...
```
1cf3b9c [R1/1.11] docs: War Room bundle + Lighthouse pre-check
```
...
| Service | Detail |
|---|---|
| Repo | `armaansarora/internship-command-center` on `main` (commit `1cf3b9c`) |
...
| File | Lines | ~Tokens |
|---|---|---|
| `BOOTSTRAP-PROMPT.md` | 648 | 6,542 |
| `PROJECT-CONTEXT.md` | 282 | 5,274 |
| `docs/MASTER-PLAN.md` | 367 | 7,172 |
| `CLAUDE.md` | 427 | 8,696 |
| **Total** | **1724** | **27,684** |

> ⚠️ Reading all recommended files consumes ~27,684 tokens. Prioritize: this file → CLAUDE.md (mandatory) → PROJECT-CONTEXT.md → MASTER-PLAN.md.
