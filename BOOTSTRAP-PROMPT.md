...
> **Auto-generated** by `scripts/generate-bootstrap.ts` on Tuesday, April 21, 2026 at 10:00 PM EDT
...
```
a7c8cfc docs: roadmap v6 — strip all time targets, pace framing is event-driven
```
...
| Service | Detail |
|---|---|
| Repo | `armaansarora/internship-command-center` on `main` (commit `a7c8cfc`) |
...
| File | Lines | ~Tokens |
|---|---|---|
| `BOOTSTRAP-PROMPT.md` | 584 | 5,924 |
| `PROJECT-CONTEXT.md` | 279 | 5,201 |
| `docs/MASTER-PLAN.md` | 367 | 7,172 |
| `CLAUDE.md` | 315 | 6,531 |
| **Total** | **1545** | **24,828** |

> ⚠️ Reading all recommended files consumes ~24,828 tokens. Prioritize: this file → CLAUDE.md (mandatory) → PROJECT-CONTEXT.md → MASTER-PLAN.md.
