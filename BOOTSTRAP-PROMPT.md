...
> **Auto-generated** by `scripts/generate-bootstrap.ts` on Saturday, April 25, 2026 at 1:38 AM EDT
...
```
75c2e38 [R12/12.12] chore(autopilot): accept R12 — all R0-R12 phases complete, autopilot stand-down
```
...
| Service | Detail |
|---|---|
| Repo | `armaansarora/internship-command-center` on `main` (commit `75c2e38`) |
...
| File | Lines | ~Tokens |
|---|---|---|
| `BOOTSTRAP-PROMPT.md` | 1157 | 13,127 |
| `PROJECT-CONTEXT.md` | 277 | 5,128 |
| `docs/MASTER-PLAN.md` | 367 | 7,172 |
| `CLAUDE.md` | 340 | 6,341 |
| **Total** | **2141** | **31,768** |

> ⚠️ Reading all recommended files consumes ~31,768 tokens. Prioritize: this file → CLAUDE.md (mandatory) → PROJECT-CONTEXT.md → MASTER-PLAN.md.
